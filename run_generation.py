...
def main():
    ...
    tokenizer_class = globals()['YTEncoder']
    print('MODEL NAME:', args.model_name_or_path)
    tokenizer = tokenizer_class.from_pretrained('bpe/yt.model')#args.model_name_or_path)
